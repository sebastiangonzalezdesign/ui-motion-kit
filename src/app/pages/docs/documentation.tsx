...
const Documentation = () => {
  const [selectedSection, setSelectedSection] = useState<
    'getting-started' | 'customization' | 'motion-system' | 'theming'
  >('getting-started');
  ...
  const sections = [
    ...
    { id: 'theming', label: 'Theming', description: 'Light/dark mode and extensibility' },
  ] as const;
...
<ThemeProvider theme={customTheme}>
  ...
  return (
    <div className="documentation-page">
      ...
      <section className="doc-navigation">
        <div className="doc-nav">
          {sections.map((section) => (
            <button
              key={section.id}
              className={`doc-nav-button ${selectedSection === section.id ? 'active' : ''}`}
              onClick={() => setSelectedSection(section.id)}
            >
              <span className="doc-nav-label">{section.label}</span>
              <span className="doc-nav-description">{section.description}</span>
            </button>
          ))}
        </div>
      </section>
              ...
              <CodePreview
                ...
                preview={
                  <div className="installation-preview">
                    <p>
                      Install via npm or yarn to get started with the complete component library.
                    </p>
                  </div>
                }
              ...
              <CodePreview
                ...
                preview={
                  <div className="setup-preview">
                    <p>The ThemeProvider enables theme switching and component customization.</p>
                  </div>
                }
                code={setupCode}
              />
    ...
    <Button size="md" onClick={() => alert('Hello!')}>
      ...
      {selectedSection === 'customization' && (
        <section className="doc-section">
          ...
          <p className="section-description">
            Learn how to customize design tokens, override component styles, and make Motion UI Kit
