    ...
    <nav className="navbar" ref={navbarRef}>
      ...
      {viewport === 'mobile' && (
        <ul className={`navbar-nav main ${isMenuOpen ? 'active' : ''}`}>
          ...
          <li>
            <Link to="/docs/design-tokens" onClick={() => setIsMenuOpen(false)}>
              Design Tokens
            </Link>
          </li>
          <li>
            <Link to="/docs/components" onClick={() => setIsMenuOpen(false)}>
              Components
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/docs/changelog" onClick={() => setIsMenuOpen(false)}>
              Changelog
            </Link>
          </li>
        </ul>
